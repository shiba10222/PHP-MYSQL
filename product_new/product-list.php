...
if (isset($_GET["category"])) {
    ...
    $sql = "SELECT products.*, category.name AS category_name, productimages.ImageName  FROM products
                ...
                <?php foreach ($rows as $prod) : ?>
                    <tr>
                        ...
                        <td class="box align-middle">
                            <img class="object-fit-cover img-fluid" src="/PHP-MYSQL/product_all/product_images/<?= $prod["ImageName"] ?>" alt="">
                        </td>
